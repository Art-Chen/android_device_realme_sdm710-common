...
const std::map<int32_t, TouchscreenGesture::GestureInfo> TouchscreenGesture::kGestureInfoMap = {
    ...
    {2, {65, "Left swipe", "/proc/touchpanel/right_swipe_enable"}},
    {3, {253, "Right arrow", "/proc/touchpanel/left_arrow_enable"}},
    {4, {63, "Right swipe", "/proc/touchpanel/left_swipe_enable"}},
    {5, {255, "Up arrow", "/proc/touchpanel/down_arrow_enable"}},
    {6, {64, "Up swipe", "/proc/touchpanel/down_swipe_enable"}},
    {7, {252, "Down arrow", "/proc/touchpanel/up_arrow_enable"}},
    {8, {66, "Down swipe", "/proc/touchpanel/up_swipe_enable"}},
